...
<div class="row">
  <div class="col-11">
        <i class="fas fa-motorcycle mr-2" style="font-size: 25px; color: red"></i>
        <span class="" id="labletext"><b>Have a Trade-in ?(optional)</b></span>
       </div>


       <div class="col-1 "   >
          <h3 class="title" >
<span><i class="fa fa-angle-down icon"></i></span>
</h3>
          </div>
          </div>
          </div>
    ...
    <div class="panel--body" v-if="openAccordion">
      ...
      <div class="row" v-if="tradeIn">
        <div class="col-sm-12 col-lg-6 col-md-6 col-xs-12">
          <label class="label label-default">Select Year<i id="a">*</i> </label>
          <div class="input-group mb-3">
            <select id="t" class="form-select">
              <option selected>Select Year</option>
              <option v-for="n in 2021" :key="n">{{ n }}</option>
            </select>
          </div>
        </div>
        <div class="col-sm-12 col-lg-6 col-md-6 col-xs-12">
